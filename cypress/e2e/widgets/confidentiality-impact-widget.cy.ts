...
describe("Confidentiality Impact Widget", () => {
  ...
  it("displays confidentiality impact analysis", () => {
    ...
    // Find the confidentiality impact widget
    cy.findWidget('confidentiality-impact')
      .should('exist')
      .scrollIntoView();
  ...
  it("updates content when confidentiality security level changes", () => {
    ...
    testWidgetUpdatesWithSecurityLevels(
      ...
      {
        initialLevels: [SECURITY_LEVELS.MODERATE, SECURITY_LEVELS.MODERATE, SECURITY_LEVELS.LOW],
        newLevels: [SECURITY_LEVELS.MODERATE, SECURITY_LEVELS.MODERATE, SECURITY_LEVELS.HIGH],
