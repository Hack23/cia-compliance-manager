...
/**
 * Custom hook for TechnicalDetailsWidget helper functions and default data
...
// Default expertise requirements based on component and security level
