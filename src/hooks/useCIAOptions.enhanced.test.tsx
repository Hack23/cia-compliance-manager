...
vi.mock('./useCIAOptions', () => {
  const mockOptions = {
    availabilityOptions: {
      None: { description: "Test None", capex: 0, opex: 0, bg: '#fff', text: '#000', recommendations: [], businessImpact: '', technical: '' },
      Low: { description: "Test Low", capex: 5000, opex: 1000, bg: '#fff', text: '#000', recommendations: [], businessImpact: '', technical: '' },
      Moderate: { description: "Test Moderate", capex: 10000, opex: 2000, bg: '#fff', text: '#000', recommendations: [], businessImpact: '', technical: '' },
      High: { description: "Test High", capex: 20000, opex: 4000, bg: '#fff', text: '#000', recommendations: [], businessImpact: '', technical: '' },
      "Very High": { description: "Test Very High", capex: 40000, opex: 8000, bg: '#fff', text: '#000', recommendations: [], businessImpact: '', technical: '' },
    },
    integrityOptions: {
      None: { description: "Test None", capex: 0, opex: 0, bg: '#fff', text: '#000', recommendations: [], businessImpact: '', technical: '' },
      Low: { description: "Test Low", capex: 5000, opex: 1000, bg: '#fff', text: '#000', recommendations: [], businessImpact: '', technical: '' },
    ...
    ROI_ESTIMATES: {
      ...
      MODERATE: { returnRate: "100%", description: "Test MODERATE", value: "100%" },
      HIGH: { returnRate: "200%", description: "Test HIGH", value: "200%" },
      VERY_HIGH: { returnRate: "500%", description: "Test VERY_HIGH", value: "500%" },
    },
  };
