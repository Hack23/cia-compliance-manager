...
describe("Type Guard Utilities", () => {
  describe("Basic Type Guards", () => {
    ...
    it("isObject correctly identifies objects", () => {
      ...
      expect(isObject([])).toBe(true); // Arrays are also objects in JavaScript
  ...
  describe("CIA Specific Type Guards", () => {
    ...
    it("isCIADetails validates complete CIA details", () => {
      ...
      expect(isCIADetails({ ...validDetails, description: undefined })).toBe(false);
      expect(isCIADetails({ ...validDetails, technical: undefined })).toBe(false);
      expect(isCIADetails({ ...validDetails, businessImpact: undefined })).toBe(false);
      ...
      expect(isCIADetails({ ...validDetails, recommendations: undefined })).toBe(false);
  ...
  describe("Detail Type Guards", () => {
    it("isAvailabilityDetail validates availability details", () => {
      ...
      // Missing required fields
      expect(isAvailabilityDetail({ ...validDetail, description: undefined })).toBe(false);
      expect(isAvailabilityDetail({ ...validDetail, businessImpact: undefined })).toBe(false);
      expect(isAvailabilityDetail({ ...validDetail, uptime: undefined })).toBe(false);
      expect(isAvailabilityDetail({ ...validDetail, recommendations: undefined })).toBe(false);
    });
    ...
    it("isIntegrityDetail validates integrity details", () => {
      ...
      // Missing required fields
      expect(isIntegrityDetail({ ...validDetail, description: undefined })).toBe(false);
      expect(isIntegrityDetail({ ...validDetail, businessImpact: undefined })).toBe(false);
      expect(isIntegrityDetail({ ...validDetail, recommendations: undefined })).toBe(false);
    });
    ...
    it("isConfidentialityDetail validates confidentiality details", () => {
      ...
      // Missing required fields
      expect(isConfidentialityDetail({ ...validDetail, impact: undefined })).toBe(false);
      expect(isConfidentialityDetail({ ...validDetail, businessImpact: undefined })).toBe(false);
      expect(isConfidentialityDetail({ ...validDetail, recommendations: undefined })).toBe(false);
    });
    ...
    it("isBusinessImpactDetails validates business impact details", () => {
      ...
      // Missing required fields
      expect(isBusinessImpactDetails({ ...validDetails, summary: undefined })).toBe(false);
  ...
  describe("Security Profile Type Guards", () => {
    it("isSecurityProfile validates security profiles", () => {
      ...
      // Missing required fields
      expect(isSecurityProfile({ ...validProfile, availability: undefined })).toBe(false);
      expect(isSecurityProfile({ ...validProfile, integrity: undefined })).toBe(false);
      expect(isSecurityProfile({ ...validProfile, confidentiality: undefined })).toBe(false);
      expect(isSecurityProfile({ ...validProfile, overall: undefined })).toBe(false);
  ...
  describe("Utility Functions", () => {
    ...
    it("getSecurityLevelOption safely accesses security level options", () => {
      ...
      expect(getSecurityLevelOption(options, "Very High")).toEqual({ value: 4 });
