...
describe('SecurityLevelWidget', () => {
  ...
  test('renders with specified security levels', () => {
    ...
    expect(screen.getByTestId('security-level-widget-availability-summary')).toHaveTextContent(/High/);
    expect(screen.getByTestId('security-level-widget-integrity-summary')).toHaveTextContent(/Low/);
    expect(screen.getByTestId('security-level-widget-confidentiality-summary')).toHaveTextContent(/Very High/);
  });
  ...
  test('displays loading state correctly', () => {
    ...
    vi.mock('../common/WidgetContainer', () => ({
      default: ({ children }: { children: ReactNode }) => <div data-testid="widget-container-mock">{children}</div>,
    }));
