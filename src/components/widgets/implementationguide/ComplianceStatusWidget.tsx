...
const ComplianceStatusWidget: React.FC<ComplianceStatusWidgetProps> = ({
  ...
  return (
    ...
    >
      <div>
        <p className="mb-4">
          This assessment evaluates how your selected security levels align with
        ...
        {complianceResults.partiallyCompliantFrameworks.length > 0 && (
          <div
            className="mb-4"
            data-testid={COMPLIANCE_STATUS_TEST_IDS.PARTIAL}
          >
            <h3 className="font-medium mb-2">Partially Compliant Frameworks</h3>
            <div className="space-y-2">
              {complianceResults.partiallyCompliantFrameworks.map(
                (framework) => (
                  <div
