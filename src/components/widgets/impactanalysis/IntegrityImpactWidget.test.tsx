...
vi.mock("../../hooks/useCIAContentService", () => ({
  useCIAContentService: () => ({
    ciaContentService: {
      ...
      calculateBusinessImpactLevel: (a: string, i: string, c: string) =>
        "Moderate",
    },
  }),
}));
...
describe("IntegrityImpactWidget", () => {
  ...
  it("renders with default props", () => {
    ...
    expect(
      screen.getByText(WIDGET_TITLES.INTEGRITY_IMPACT)
    ).toBeInTheDocument();
  });
  ...
  it("renders description section", () => {
    createComponent();
    expect(
      screen.getByText(/Mock description for integrity at Moderate level/)
    ).toBeInTheDocument();
  });
  ...
  it("renders technical implementation section", () => {
    createComponent();
    expect(
      screen.getByText(/Mock technical details for integrity at Moderate level/)
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Mock validation method for Moderate/)
    ).toBeInTheDocument();
  });
  ...
  it("renders business impact section", () => {
    ...
    expect(
      screen.getByText(/Mock financial impact for Moderate/)
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Mock operational impact for Moderate/)
    ).toBeInTheDocument();
  });
