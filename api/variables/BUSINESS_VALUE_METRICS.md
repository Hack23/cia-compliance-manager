...
[CIA Compliance Manager API Documentation](../globals.md) / BUSINESS\_VALUE\_METRICS

# Variable: BUSINESS\_VALUE\_METRICS

> `const` **BUSINESS\_VALUE\_METRICS**: `object`

Defined in: [src/constants/businessConstants.ts:286](https://github.com/Hack23/cia-compliance-manager/blob/main/src/constants/businessConstants.ts#L286)
