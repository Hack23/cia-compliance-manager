...
[CIA Compliance Manager API Documentation](../../../modules.md) / [constants/testIds](../README.md) / TEST\_IDS

# Variable: TEST\_IDS

> `const` **TEST\_IDS**: `object`

Defined in: [src/constants/testIds.ts:409](https://github.com/Hack23/cia-compliance-manager/blob/32fe683007dd7fe1aa6b244d2353e60fab4f51de/src/constants/testIds.ts#L409)
