...
[CIA Compliance Manager API Documentation](../globals.md) / APP\_TEST\_IDS

# Variable: APP\_TEST\_IDS

> `const` **APP\_TEST\_IDS**: `object`

Defined in: [src/constants/testIds.ts:334](https://github.com/Hack23/cia-compliance-manager/blob/main/src/constants/testIds.ts#L334)
