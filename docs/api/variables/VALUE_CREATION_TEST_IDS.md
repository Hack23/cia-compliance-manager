...
[CIA Compliance Manager API Documentation](../globals.md) / VALUE\_CREATION\_TEST\_IDS

# Variable: VALUE\_CREATION\_TEST\_IDS

> `const` **VALUE\_CREATION\_TEST\_IDS**: `object`

Defined in: [src/constants/testIds.ts:461](https://github.com/Hack23/cia-compliance-manager/blob/main/src/constants/testIds.ts#L461)
