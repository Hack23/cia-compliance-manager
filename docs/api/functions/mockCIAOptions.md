...
[CIA Compliance Manager API Documentation](../globals.md) / mockCIAOptions

# Function: mockCIAOptions()

> **mockCIAOptions**(): `object`

Defined in: [src/tests/testUtils/index.ts:10](https://github.com/Hack23/cia-compliance-manager/blob/main/src/tests/testUtils/index.ts#L10)
