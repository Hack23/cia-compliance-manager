...
[CIA Compliance Manager API Documentation](../globals.md) / createMockCIAOptions

# Function: createMockCIAOptions()

> **createMockCIAOptions**(): `object`

Defined in: [src/utils/test-helpers.ts:29](https://github.com/Hack23/cia-compliance-manager/blob/main/src/utils/test-helpers.ts#L29)
